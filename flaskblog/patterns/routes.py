...
@patterns.route("/patterns/sections/<int:section_id>")
...
@patterns.route("/patterns/sections/<int:section_id>/update", methods=['GET', 'POST'])
@login_required
...
@patterns.route("/patterns/<int:title>/update", methods=['GET', 'POST'])
@login_required
